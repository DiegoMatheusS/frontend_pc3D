      ...
      <main className="page-container mounted-detail__main">
        ...
        <section className="mounted-detail__section" id="ofertas">
          <header>
            ...
            <p className="mounted-detail__offers-note"><strong>Importante:</strong> as peças em oferta relacionadas abaixo são ofertas do CriaByte para compra separada e <strong>não estão vinculadas diretamente ao computador em promoção</strong>.</p>
          </header>
