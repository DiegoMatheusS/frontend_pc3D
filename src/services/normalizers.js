...
const CATEGORY_META = {
  ...
  PC_MONTADO: ['computadores', 'PC montado', 'pcs-montados'],
  MINI_COMPUTADOR: ['computadores', 'Mini computador', 'mini-computadores'],
  CELULAR: ['celulares', 'Celular', 'celulares'],
  TELEFONE: ['celulares', 'Telefone', 'telefones'],
  TABLET: ['tablets', 'Tablet', 'tablets'],
  E_READER: ['tablets', 'E-reader', 'e-readers'],
  VIDEOGAME: ['games', 'Videogame e console', 'videogames-consoles'],
  JOGO: ['games', 'Jogo', 'jogos'],
  JOYSTICK: ['games', 'Joystick', 'joysticks'],
  CONTROLE_VIDEO_GAME: ['games', 'Controle de videogame', 'controles-videogame'],
  VOLANTE: ['games', 'Volante', 'volantes'],
  SMART_TV: ['tv-audio', 'Smart TV', 'smart-tvs'],
  TV: ['tv-audio', 'TV', 'tvs'],
  CAIXA_DE_SOM: ['tv-audio', 'Caixa de som', 'caixas-de-som'],
  SOUNDBAR: ['tv-audio', 'Soundbar', 'soundbars'],
  HOME_THEATER: ['tv-audio', 'Home theater', 'home-theaters'],
  PROJETOR: ['tv-audio', 'Projetor', 'projetores'],
  CAMERA: ['fotografia', 'Câmera e fotografia', 'cameras'],
  CAMERA_ACAO: ['fotografia', 'Câmera de ação', 'cameras-de-acao'],
  DRONE: ['fotografia', 'Drone', 'drones'],
  RELOGIO_INTELIGENTE: ['wearables', 'Relógio inteligente', 'relogios-inteligentes'],
  ASPIRADOR_PO: ['eletroportateis', 'Aspirador de pó', 'aspiradores-de-po'],
  ROBO_ASPIRADOR: ['eletroportateis', 'Robô aspirador', 'robos-aspiradores'],
  AIR_FRYER: ['eletroportateis', 'Air fryer', 'air-fryers'],
  CAFETEIRA: ['eletroportateis', 'Cafeteira', 'cafeteiras'],
  LIQUIDIFICADOR: ['eletroportateis', 'Liquidificador', 'liquidificadores'],
  VENTILADOR: ['eletroportateis', 'Ventilador', 'ventiladores'],
  CLIMATIZADOR: ['eletroportateis', 'Climatizador', 'climatizadores'],
  SMART_SPEAKER: ['casa-inteligente', 'Smart speaker', 'smart-speakers'],
  CAMERA_SEGURANCA: ['casa-inteligente', 'Câmera de segurança', 'cameras-de-seguranca'],
  LAMPADA_INTELIGENTE: ['casa-inteligente', 'Lâmpada inteligente', 'lampadas-inteligentes'],
  TOMADA_INTELIGENTE: ['casa-inteligente', 'Tomada inteligente', 'tomadas-inteligentes'],
  FECHADURA_INTELIGENTE: ['casa-inteligente', 'Fechadura inteligente', 'fechaduras-inteligentes'],
  ROTEADOR: ['rede', 'Roteador', 'roteadores'],
  REPETIDOR_WIFI: ['rede', 'Repetidor Wi-Fi', 'repetidores-wifi'],
  SWITCH_REDE: ['rede', 'Switch de rede', 'switches-de-rede'],
  ADAPTADOR_WIFI_BLUETOOTH: ['rede', 'Adaptador Wi-Fi/Bluetooth', 'adaptadores-wifi-bluetooth'],
  IMPRESSORA: ['impressao', 'Impressora', 'impressoras'],
  SCANNER: ['impressao', 'Scanner', 'scanners'],
  IMPRESSORA_3D: ['impressao', 'Impressora 3D', 'impressoras-3d'],
  ACESSORIO_IMPRESSAO_3D: ['impressao', 'Acessório para impressão 3D', 'acessorios-impressao-3d'],
  MICROCONTROLADOR: ['maker', 'Microcontrolador', 'microcontroladores'],
  KIT_ARDUINO_ROBOTICA: ['maker', 'Kit Arduino e robótica', 'kits-arduino-robotica'],
  CARREGADOR: ['acessorios', 'Carregador', 'carregadores'],
  POWER_BANK: ['acessorios', 'Power bank', 'power-banks'],
  CABO_ADAPTADOR: ['acessorios', 'Cabo e adaptador', 'cabos-adaptadores'],
  HUB_USB: ['acessorios', 'Hub USB', 'hubs-usb'],
  DOCK_STATION: ['acessorios', 'Dock station', 'dock-stations'],
  PEN_DRIVE: ['acessorios', 'Pen drive', 'pen-drives'],
  CARTAO_MEMORIA: ['acessorios', 'Cartão de memória', 'cartoes-de-memoria'],
  LEITOR_CARTAO: ['acessorios', 'Leitor de cartão', 'leitores-de-cartao'],
  ARMAZENAMENTO_EXTERNO: ['acessorios', 'Armazenamento externo', 'armazenamento-externo'],
  NOBREAK: ['acessorios', 'Nobreak', 'nobreaks'],
  ESTABILIZADOR: ['acessorios', 'Estabilizador', 'estabilizadores'],
  FILTRO_DE_LINHA: ['acessorios', 'Filtro de linha', 'filtros-de-linha'],
  CALCULADORA: ['acessorios', 'Calculadora', 'calculadoras'],
}
...
const CATEGORY_ALIASES = {
  ...
  NOTEBOOKS: 'NOTEBOOK',
  NOTEBOOK: 'NOTEBOOK',
  PCS_MONTADOS: 'PC_MONTADO',
  PC_MONTADO: 'PC_MONTADO',
  MINI_COMPUTADORES: 'MINI_COMPUTADOR',
  MINI_COMPUTADOR: 'MINI_COMPUTADOR',
  CELULARES: 'CELULAR',
  CELULAR: 'CELULAR',
  TELEFONES: 'TELEFONE',
  TELEFONE: 'TELEFONE',
  ...
  E_READERS: 'E_READER',
  E_READER: 'E_READER',
  VIDEOGAMES_CONSOLES: 'VIDEOGAME',
  VIDEOGAMES_E_CONSOLES: 'VIDEOGAME',
  VIDEOGAME: 'VIDEOGAME',
  JOGOS: 'JOGO',
  JOGO: 'JOGO',
  JOYSTICKS: 'JOYSTICK',
  JOYSTICK: 'JOYSTICK',
  CONTROLES_VIDEOGAME: 'CONTROLE_VIDEO_GAME',
  CONTROLE_VIDEO_GAME: 'CONTROLE_VIDEO_GAME',
  VOLANTES: 'VOLANTE',
  VOLANTE: 'VOLANTE',
  SMART_TVS: 'SMART_TV',
  SMART_TV: 'SMART_TV',
  TVS: 'TV',
  TV: 'TV',
  CAIXAS_DE_SOM: 'CAIXA_DE_SOM',
  CAIXA_DE_SOM: 'CAIXA_DE_SOM',
  SOUNDBARS: 'SOUNDBAR',
  SOUNDBAR: 'SOUNDBAR',
  HOME_THEATERS: 'HOME_THEATER',
  HOME_THEATER: 'HOME_THEATER',
  PROJETORES: 'PROJETOR',
  PROJETOR: 'PROJETOR',
  CAMERAS_E_FOTOGRAFIA: 'CAMERA',
  CAMERAS: 'CAMERA',
  CAMERA: 'CAMERA',
  CAMERAS_DE_ACAO: 'CAMERA_ACAO',
  CAMERA_ACAO: 'CAMERA_ACAO',
  DRONES: 'DRONE',
  DRONE: 'DRONE',
  RELOGIOS_INTELIGENTES: 'RELOGIO_INTELIGENTE',
  RELOGIO_INTELIGENTE: 'RELOGIO_INTELIGENTE',
  ASPIRADORES_DE_PO: 'ASPIRADOR_PO',
  ASPIRADOR_PO: 'ASPIRADOR_PO',
  ROBOS_ASPIRADORES: 'ROBO_ASPIRADOR',
  ROBO_ASPIRADOR: 'ROBO_ASPIRADOR',
  ...
  SMART_SPEAKERS: 'SMART_SPEAKER',
  SMART_SPEAKER: 'SMART_SPEAKER',
  CAMERAS_DE_SEGURANCA: 'CAMERA_SEGURANCA',
  CAMERA_SEGURANCA: 'CAMERA_SEGURANCA',
  LAMPADAS_INTELIGENTES: 'LAMPADA_INTELIGENTE',
  LAMPADA_INTELIGENTE: 'LAMPADA_INTELIGENTE',
  TOMADAS_INTELIGENTES: 'TOMADA_INTELIGENTE',
  TOMADA_INTELIGENTE: 'TOMADA_INTELIGENTE',
  FECHADURAS_INTELIGENTES: 'FECHADURA_INTELIGENTE',
  FECHADURA_INTELIGENTE: 'FECHADURA_INTELIGENTE',
  ROTEADORES: 'ROTEADOR',
  ROTEADOR: 'ROTEADOR',
  REPETIDORES_WIFI: 'REPETIDOR_WIFI',
  REPETIDOR_WIFI: 'REPETIDOR_WIFI',
  SWITCHES_DE_REDE: 'SWITCH_REDE',
  SWITCH_REDE: 'SWITCH_REDE',
  ADAPTADORES_WIFI_E_BLUETOOTH: 'ADAPTADOR_WIFI_BLUETOOTH',
  ADAPTADORES_WIFI_BLUETOOTH: 'ADAPTADOR_WIFI_BLUETOOTH',
  ADAPTADOR_WIFI_BLUETOOTH: 'ADAPTADOR_WIFI_BLUETOOTH',
  IMPRESSORAS: 'IMPRESSORA',
  IMPRESSORA: 'IMPRESSORA',
  SCANNERS: 'SCANNER',
  SCANNER: 'SCANNER',
  IMPRESSORAS_3D: 'IMPRESSORA_3D',
  IMPRESSORA_3D: 'IMPRESSORA_3D',
  ACESSORIOS_IMPRESSAO_3D: 'ACESSORIO_IMPRESSAO_3D',
  ACESSORIO_IMPRESSAO_3D: 'ACESSORIO_IMPRESSAO_3D',
  MICROCONTROLADORES: 'MICROCONTROLADOR',
  MICROCONTROLADOR: 'MICROCONTROLADOR',
  KITS_ARDUINO_E_ROBOTICA: 'KIT_ARDUINO_ROBOTICA',
  KIT_ARDUINO_ROBOTICA: 'KIT_ARDUINO_ROBOTICA',
  CARREGADORES: 'CARREGADOR',
  CARREGADOR: 'CARREGADOR',
  POWER_BANKS: 'POWER_BANK',
  POWER_BANK: 'POWER_BANK',
  CABOS_E_ADAPTADORES: 'CABO_ADAPTADOR',
  CABOS_ADAPTADORES: 'CABO_ADAPTADOR',
  CABO_ADAPTADOR: 'CABO_ADAPTADOR',
  HUBS_USB: 'HUB_USB',
  HUB_USB: 'HUB_USB',
  DOCK_STATIONS: 'DOCK_STATION',
  DOCK_STATION: 'DOCK_STATION',
  PEN_DRIVES: 'PEN_DRIVE',
  PEN_DRIVE: 'PEN_DRIVE',
  CARTOES_DE_MEMORIA: 'CARTAO_MEMORIA',
  CARTAO_MEMORIA: 'CARTAO_MEMORIA',
  LEITORES_DE_CARTAO: 'LEITOR_CARTAO',
  LEITOR_CARTAO: 'LEITOR_CARTAO',
  ARMAZENAMENTO_EXTERNO: 'ARMAZENAMENTO_EXTERNO',
  HDS_E_SSDS_EXTERNOS: 'ARMAZENAMENTO_EXTERNO',
  NOBREAKS: 'NOBREAK',
  NOBREAK: 'NOBREAK',
  ESTABILIZADORES: 'ESTABILIZADOR',
  ESTABILIZADOR: 'ESTABILIZADOR',
  FILTROS_DE_LINHA: 'FILTRO_DE_LINHA',
  FILTRO_DE_LINHA: 'FILTRO_DE_LINHA',
