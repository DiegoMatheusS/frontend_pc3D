...
async function getHeroGpuModelUrl() {
  const model = await apiRequest('/api/hardwares/modelos-3d/home')
  if (!model || model.ativo !== true || model.aprovado !== true || model.mostrarNoHome !== true) return ''
  return resolveModelUrl(model.arquivoUrl)
}
